    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white pt-20">
        <div className="text-center space-y-4 max-w-md px-6">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold text-[#1A1A1A]">Blog not found</h2>
              ...
              {blog.quote && (
                <div className="bg-white p-6 sm:p-10 md:p-12 rounded-2xl sm:rounded-[30px] border border-gray-100 relative overflow-hidden flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 shadow-sm">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#F4F9F8] rounded-full flex items-center justify-center">
                      <Quote className="w-6 h-6 sm:w-8 sm:h-8 text-[#00A78E] opacity-40" />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <p className="text-base sm:text-[18px] md:text-[20px] font-semibold text-gray-600 leading-relaxed italic">
                      {blog.quote}
                    </p>
                    {(blog.quoteAuthor || blog.quoteAuthorRole) && (
                      <div>
                        <h4 className="font-semibold text-[#1A1A1A] text-base sm:text-lg">
                          {blog.quoteAuthor}
                        </h4>
                        <p className="text-gray-400 font-semibold text-xs sm:text-sm uppercase">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <ul className="space-y-4">
                    {blog.points.map((point: string, i: number) => (
                      <li
                        key={i}
                        className="flex items-start space-x-3 text-gray-500 font-semibold text-base sm:text-lg"
                      >
                        <ChevronsRight className="w-5 h-5 text-[#00A78E] flex-shrink-0 mt-0.5" />
                        <span>{point}</span>
                      </li>
                    ))}
                  </ul>
