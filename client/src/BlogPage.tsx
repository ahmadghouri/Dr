          ...
          <div className="lg:w-[65%] space-y-10">
            ...
            <div className="flex items-center justify-center space-x-3 pt-10">
              ...
              <button
                ...
                className="w-12 h-12 rounded-full flex items-center justify-center bg-white border-2 border-gray-100 text-gray-400 hover:border-[#00A78E] hover:text-[#1A1A1A] transition-all"
              >
