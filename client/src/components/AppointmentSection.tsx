...
const AppointmentSection = () => {
  return (
    ...
    <section className="py-10 lg:py-20 bg-gray-50/30 overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6 relative flex flex-col lg:flex-row items-center">
        
        {/* Left Side: Image Container - Perfect responsive spacing */}
        <div className="w-full lg:w-[60%] relative z-0">
          <img 
            src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=2080&auto=format&fit=crop" 
            alt="Doctors Consulting" 
            // Fixed h-150 to highly responsive classes
            className="w-full h-[320px] sm:h-[400px] md:h-[48px] lg:h-[600px] object-cover rounded-[30px] shadow-lg"
          />
        ...
        <div className="w-full lg:w-[50%] lg:-ml-[10%] mt-8 lg:mt-0 relative z-10">
          <div className="bg-white rounded-[30px] p-6 md:p-12 shadow-2xl shadow-black/5 border border-gray-100">
            ...
            <form className="space-y-4 sm:space-y-6">
              ...
              <button className="w-full bg-[#00A78E] text-white py-4 sm:py-5 rounded-2xl font-semibold text-base sm:text-lg flex items-center justify-center group hover:bg-[#008f7a] transition-all shadow-lg shadow-[#00A78E]/20">
                <span>Book An Appointment</span>
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </form>
