...
//       {/* Heartbeat Background Pattern (Simplified SVG representation) */}
...
//               <div className="absolute -bottom-2 left-0 w-full h-1 bg-[#00A78E]/40 rounded-full"></div>
//             </span>
//           </h2>

//           <div className="max-w-xl mx-auto flex items-center bg-[#151515] rounded-full p-2 border border-gray-800 shadow-xl">
...
//             />
//             <button className="bg-[#C1FF72] text-black px-6 py-3 rounded-full font-semibold flex items-center space-x-2 hover:bg-[#b0f060] transition-colors">
...
//               <div className="w-10 h-10 bg-[#00A78E] rounded-xl flex items-center justify-center">
...
//               {[Facebook, Linkedin, Instagram, X].map((Icon, idx) => (
...
//               {['About Us', 'Services', 'Why Chose Us', 'Doctors', 'Blog And News'].map((link) => (
//                 <li key={link} className="text-gray-400 text-sm hover:text-[#00A78E] cursor-pointer transition-colors">
//                   {link}
//                 </li>
//               ))}
//             </ul>
...
//             <ul className="space-y-4">
//               {['Terms & Condition', 'Privacy Policy', 'Contact Us', 'Terms Of Use'].map((link) => (
//                 <li key={link} className="text-gray-400 text-sm hover:text-[#00A78E] cursor-pointer transition-colors">
//                   {link}
//                 </li>
//               ))}
...
//           <p>© 2025 MediZen | All Rights Reserved</p>
//         </div>
