...
const Hero = () => {
  ...
  return (
    <section
      ...
      className="relative min-h-[80vh] sm:min-h-[600px] lg:min-h-[500px] flex items-center justify-center overflow-hidden bg-white px-4 sm:px-6 w-full"
    >
      ...
      {/* Content Inner Wrapper - Balanced margins for new low heights */}
      <div className="max-w-[1200px] mx-auto mt-0 sm:mt-0 lg:mt-0 md:pt-0 text-center relative z-10 w-full">
        ...
        <div className="relative select-none group py-2 flex justify-center w-full">
          {/* Base Text */}
          ...
          <motion.div
            className="absolute inset-0 pointer-events-none overflow-hidden flex items-center justify-center w-full"
            style={{
              clipPath: isHovered
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-5 sm:space-y-0 sm:space-x-10 mt-10 sm:mt-12 w-full">
          ...
          {/* New Learn More Button with Navigation */}
          <button 
            onClick={() => navigate("/about")}
            className="flex items-center cursor-pointer space-x-4 group shrink-0"
          >
            ...
            <span className="text-lg sm:text-xl font-semibold text-[#1A1A1A] group-hover:text-[#00A78E] transition-colors duration-300">
              Learn More
            </span>
          </button>
        </div>
