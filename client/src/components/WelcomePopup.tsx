              ...
              <div className="bg-[#F8FBFB] p-4 sm:p-5 pt-4 space-y-4 flex-1 flex flex-col justify-between">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 px-1">
                    ...
                    <div>
                      <h4 className="text-xs sm:text-sm font-bold text-gray-900 leading-tight">Available Mon - Sat</h4>
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 rounded-2xl bg-white/50 border border-gray-100/80 shadow-sm">
                    ...
                    <div>
                      <h4 className="text-xs sm:text-sm font-bold text-gray-900 leading-tight">Call Now</h4>
                      <p className="text-xs text-[#059781] mt-0.5 font-extrabold tracking-wide">0300-396-8500</p>
                    </div>
                  </div>
                </div>
